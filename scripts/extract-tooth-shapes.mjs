...
function canineOutline(w, h) {
  return `M ${w*0.42} ${-h*0.012} C ${w*0.50} ${-h*0.018} ${w*0.51} ${-h*0.12} ${w*0.49} ${-h*0.25} C ${w*0.47} ${-h*0.31} ${w*0.43} ${-h*0.34} ${w*0.39} ${-h*0.36} C ${w*0.28} ${-h*0.46} ${w*0.18} ${-h*0.60} ${w*0.04} ${-h*0.94} C ${w*0.02} ${-h*0.98} ${-w*0.02} ${-h*0.98} ${-w*0.04} ${-h*0.94} C ${-w*0.18} ${-h*0.60} ${-w*0.28} ${-h*0.46} ${-w*0.39} ${-h*0.36} C ${-w*0.43} ${-h*0.34} ${-w*0.47} ${-h*0.31} ${-w*0.49} ${-h*0.25} C ${-w*0.51} ${-h*0.12} ${-w*0.50} ${-h*0.018} ${-w*0.42} ${-h*0.012} C ${-w*0.34} ${-h*0.006} ${w*0.34} ${-h*0.006} ${w*0.42} ${-h*0.012} Z`;
}
