...
function incisorOutline(w, h) {
  return `M ${w*0.42} ${-h*0.012} C ${w*0.495} ${-h*0.018} ${w*0.505} ${-h*0.12} ${w*0.48} ${-h*0.24} C ${w*0.46} ${-h*0.30} ${w*0.42} ${-h*0.33} ${w*0.38} ${-h*0.35} C ${w*0.28} ${-h*0.44} ${w*0.18} ${-h*0.60} ${w*0.04} ${-h*0.94} C ${w*0.02} ${-h*0.98} ${-w*0.02} ${-h*0.98} ${-w*0.04} ${-h*0.94} C ${-w*0.18} ${-h*0.60} ${-w*0.28} ${-h*0.44} ${-w*0.38} ${-h*0.35} C ${-w*0.42} ${-h*0.33} ${-w*0.46} ${-h*0.30} ${-w*0.48} ${-h*0.24} C ${-w*0.505} ${-h*0.12} ${-w*0.495} ${-h*0.018} ${-w*0.42} ${-h*0.012} C ${-w*0.345} ${-h*0.006} ${w*0.345} ${-h*0.006} ${w*0.42} ${-h*0.012} Z`;
}
...
function canineOutline(w, h) {
  const ch = h * 0.34; const ny = -ch; const nw = w * 0.80; const tipW = w * 0.04;
  return `M ${w*0.44} ${-h*0.058} C ${w*0.50} ${-h*0.10} ${w*0.50} ${-h*0.28} ${nw*0.50} ${ny} C ${w*0.28} ${-h*0.46} ${w*0.18} ${-h*0.60} ${tipW} ${-h*0.94} C ${tipW*0.5} ${-h} ${-tipW*0.5} ${-h} ${-tipW} ${-h*0.94} C ${-w*0.18} ${-h*0.60} ${-w*0.28} ${-h*0.46} ${-nw*0.50} ${ny} C ${-w*0.50} ${-h*0.28} ${-w*0.50} ${-h*0.10} ${-w*0.44} ${-h*0.058} C ${-w*0.40} ${-h*0.020} ${-w*0.27} ${-h*0.016} 0 ${-h*0.006} C ${w*0.27} ${-h*0.016} ${w*0.40} ${-h*0.020} ${w*0.44} ${-h*0.058} Z`;
}
