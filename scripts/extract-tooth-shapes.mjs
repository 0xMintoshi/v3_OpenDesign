...
function wisdomUOutline(w, h) {
  return `M ${w*0.3825} ${h*0.0132} C ${w*0.4364} ${h*0.0008} ${w*0.4873} ${-h*0.0534} ${w*0.4963} ${-h*0.1079} C ${w*0.5097} ${-h*0.214} ${w*0.5089} ${-h*0.316} ${w*0.4846} ${-h*0.3837} C ${w*0.4489} ${-h*0.4258} ${w*0.3982} ${-h*0.4991} ${w*0.3713} ${-h*0.5473} C ${w*0.3403} ${-h*0.5872} ${w*0.2965} ${-h*0.6564} ${w*0.24} ${-h*0.86} C ${w*0.20} ${-h*0.96} ${w*0.14} ${-h*0.96} ${w*0.12} ${-h*0.86} C ${w*0.10} ${-h*0.74} ${w*0.06} ${-h*0.62} 0 ${-h*0.60} C ${-w*0.06} ${-h*0.62} ${-w*0.10} ${-h*0.74} ${-w*0.12} ${-h*0.86} C ${-w*0.14} ${-h*0.96} ${-w*0.20} ${-h*0.96} ${-w*0.24} ${-h*0.86} C ${-w*0.2965} ${-h*0.6564} ${-w*0.3403} ${-h*0.5872} ${-w*0.3713} ${-h*0.5473} C ${-w*0.3982} ${-h*0.4991} ${-w*0.4489} ${-h*0.4258} ${-w*0.4846} ${-h*0.3837} C ${-w*0.5089} ${-h*0.316} ${-w*0.5097} ${-h*0.214} ${-w*0.4963} ${-h*0.1079} C ${-w*0.4873} ${-h*0.0534} ${-w*0.4364} ${h*0.0008} ${-w*0.3825} ${h*0.0132} C ${-w*0.0942} ${h*0.0753} ${w*0.0942} ${h*0.0753} ${w*0.3825} ${h*0.0132} Z`;
}
